...
public class upcomingService {
    public static void upcomingMovies(Callback callback) {
        OkHttpClient client = new OkHttpClient.Builder()
                .build();

        HttpUrl.Builder urlBuilder = HttpUrl.parse(Constants.MOVIELIST_UPCOMING).newBuilder();
        String url = urlBuilder.build().toString() + Constants.THE_MOVIE_Db_Api ;
