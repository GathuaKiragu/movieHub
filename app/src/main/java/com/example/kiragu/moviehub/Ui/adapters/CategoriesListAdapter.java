...
public class CategoriesListAdapter extends RecyclerView.Adapter<CategoriesListAdapter.CategoriesViewHolder> {
        ...
        public CategoriesListAdapter(Context context, ArrayList<MovieSearch> movieSearches){
            mContext = context;
    ...
    /**
         ...
         */
        @Override
        public void onBindViewHolder(CategoriesListAdapter.CategoriesViewHolder holder, int position){
